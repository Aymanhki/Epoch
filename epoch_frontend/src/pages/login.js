                        ...
                        <div className="login-form">
                            <form onSubmit={handleSubmit} data-testid="login-form">
                                ...
                                <button type="submit" data-testid="login-button"
                                        id="login-button">{signingInPrompt}</button>
                            ...
                            <div className="login-form">
                                <form onSubmit={handleSubmit} data-testid="login-form">
                                    ...
                                    <input type="password" id="password" name="password"
                                           data-testid="password-input-field" value={password} onChange={(e) => {
                                        setPassword(e.target.value);
                                        setPasswordError(false);
                                        setGeneralError(false);
                                    }}/>
                            ...
                            <div className="app-description">
                                <div className="description-box">
                                    ...
                                    <p className={"space"}>
                                        ...
                                        people's capsules and vote them up or down depending on the accuracy or
                                        likeability
                                        of the time capsule or prediction. Create your network of followers, explore
                                        popular
                                        hashtags, and comment and share your favorite capsules. Save your favorite
                                        capsules
                                        to your profile and keep track of your own capsules and the capsules you've
                                        interacted with. Epoch is a place to share your thoughts and predictions with
                                        the
